...
%>   
 ...
 <div class="row">
    ...
    <div class="col" style="background-color: white;"><br><br>
        <center><h5>PAYMENT PROCESS</h5></center><br>
    ...
    <div class="col-6 rounded ">
        ...
        <h5 class="font-monospace" style="color:#FA9483">DETAILS :</h5><br>

            <h6 class="fw-normal" ><%=customer_data.getString("name").toUpperCase()%>    
          </h6>
            <h6 class="fw-normal"><%=customer_data.getString("phone").toUpperCase()%> </h6>
            <h6 class="fw-normal"><%=customer_data.getString("email").toUpperCase()%> </h6>
    ...
    <div class="col-5" >
        <div class="form-check " >
          <input class="form-check-input" type="radio"    onclick="javascript:yesnoCheck();" value="CASH ON DELIVERY" name="yesno" id="noCheck" required>
          <label class="form-check-label" for="flexRadioDefault1">
            <p class="input_text">CASH ON DELIVERY</p>
          </label>
        </div>
        <div class="form-check">
          <input class="form-check-input" type="radio" onclick="javascript:yesnoCheck();" value="CARD PAYMENT" name="yesno" id="yesCheck" required>
          <label class="form-check-label" for="flexRadioDefault2">
            ...
            <div class="col-md-12 shadow p-3 mb-5 bg-body rounded   top-0 end-0" id="ifYes" style="display: none;">
    ...
    <div class="col-12 ">
        <a href="product.jsp" class="button_1" >CANCEL </a>&nbsp;
    <button type="button" class="button" data-bs-toggle="modal" data-bs-target="#staticBackdrop"> PROCEED NOW <i class="spinner-border ms-auto spinner-border-sm" role="status" aria-hidden="true" style="font-size: 16px; color: #ededed;"></i></button>
    </div>    
